...
from m5.objects import X86O3CPU, X86MinorCPU, NMRURP

## Memory
class MyCacheHierarchy(PrivateL1SharedL2CacheHierarchy):
    def __init__(self,l1d_size, l1d_assoc, l1i_size, l1i_assoc, l2_size, l2_assoc):
        super().__init__(
            l1d_size = l1d_size, 
            l1d_assoc = l1d_assoc, 
            l1i_size = l1i_size, 
        ...
        self.l1d_cache.replacement_policy = NMRURP()
        self.l1i_cache.replacement_policy = NMRURP()
        self.l2_cache.replacement_policy = NMRURP()
